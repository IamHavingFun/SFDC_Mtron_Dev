...
({
    ...
    doInit: function (component, event, helper) {
        helper.apex(
            ...
            switch (resData.caseData.Status__c) {
                case '답변 완료 및 평가 대기':
    ...
    doSave : function (component, event ,helper) {
        let DealerFeedback = component.get('v.initData').caseData.DealerFeedback__c;
        let Comment = component.get('v.initData').caseData.DealerFeedbackComment__c;
