/****************************************************************************************
 * @filename      : lsMSalesSearchContractController.js
 * @projectname   :
 * @author        : i2max_my.Seo
 * @date          : 2020-06-29 오전 11:29
 * @group         :
 * @group-content :
 * @description   :
 * @tester        :
 ...
 * ===============================================================
 0.1     2020-06-29 오전 11:29    i2max_my.Seo          Create
 ****************************************************************************************/
({
    /**
     * 초기거래
    ...
    doChangeStepList : function (component, event, helper) {
        const message = event.getParam("message");

        component.set('v.stepList', message.targetStepList);
        console.log('==============> stepList : ' + component.get('v.stepList'));
    },
